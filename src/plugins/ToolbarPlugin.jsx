...
export default function ToolbarPlugin({ onImageUpload }) {
  ...
  const insertImageFromURL = (editor) => {
      ...
      {blockType === "code" ? (
        <>
          <Select
            ...
            value={codeLanguage}
          />
          {/* <i className="fas fa-chevron-down inside" /> */}
        </>
      ) : (
        <>
          <button
          ...
          >
           <i className="fa-solid fa-strikethrough format"></i>
          </button>
          <button
            onClick={() => {
          ...
          >
            <i className="fa-solid fa-code format"></i>
          </button>
          <button
            onClick={insertLink}
